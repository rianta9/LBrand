...
$( "#price-slider" ).slider({
   ...
   slide: function( event, ui ) {
       $( "#min-price" ).val(ui.values[ 0 ].toLocaleString('it-IT', {style : 'currency', currency : 'VND'}));
        $( "#max-price" ).val(ui.values[ 1 ].toLocaleString('it-IT', {style : 'currency', currency : 'VND'}));
     }
  });
  $( "#min-price" ).val($( "#price-slider" ).slider( "values", 0 ).toLocaleString('it-IT', {style : 'currency', currency : 'VND'}));   
  $( "#max-price" ).val($( "#price-slider" ).slider( "values", 1 ).toLocaleString('it-IT', {style : 'currency', currency : 'VND'})); 
